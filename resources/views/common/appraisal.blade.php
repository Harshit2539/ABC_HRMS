...
@section('content')
    <div class="page-wrapper">
        <div class="container container-fluid mt-4 ">
            <div class="card">
                <div class="card-body">
                    <h4 style="text-align: center; padding-top: 15px;">Employee's Appraisal Months</h4>
                    <form class="mb-3 d-flex gap-3 align-items-center">
                        ...
                        <span class="text-muted ">🎉Showing Appraisal In Current
    ...
    <script>
                                ...
                                <div class="list-group-item d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div>
                                             ...
                                             <small>on ${new Date(el.appraisal_date).toLocaleDateString('en-GB', {
                                                 day: '2-digit',
                                                 month: 'long'
                                             })}</small>
                                         </div>
        ...
        $(document).ready(function() {
            ...
            $('#workDropdown').on('change', function() {
                ...
                fetchappraisal(selectedMonth);
            });
            const defaultMonth = $('#workDropdown').val();
            fetchappraisal(defaultMonth);
        });
    </script>
@endsection
