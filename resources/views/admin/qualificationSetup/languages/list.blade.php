            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-striped custom-table datatable LanguageList" style="font-size:0.9em !important;">
                            <thead>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="saveLanguageBtn" class="btn btn-primary">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="editLanguageModal" tabindex="-1" aria-labelledby="editLanguageModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <button type="button" id="editLanguageBtn" class="btn btn-primary">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#saveLanguageBtn').on('click', function (e) {
        e.preventDefault();
    ...
    $('#editLanguageBtn').on('click', function (e) {
        e.preventDefault();
        var id = $('#languageId').val();
        var formData = new FormData($('#editLanguageForm')[0]);
        $('.text-danger').empty();
        $('.pre-loader').show();

        $.ajax({
            url: `/languages_update/${id}`,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
