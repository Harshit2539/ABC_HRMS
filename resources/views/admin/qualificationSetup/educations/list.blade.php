                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Educations</h3>
                        </div>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-striped custom-table datatable EducationList" style="font-size:0.9em !important;">
                            <thead>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="saveEducationBtn" class="btn btn-primary">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="editEducationModal" tabindex="-1" aria-labelledby="editEducationModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <button type="button" id="editEducationBtn" class="btn btn-primary">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#saveEducationBtn').on('click', function (e) {
        e.preventDefault();
    ...
    var table = $('.EducationList').DataTable({
        responsive: true,
        processing: true,
        serverSide: false,
        searching: true,
    ...
    $('#editEducationBtn').on('click', function (e) {
        e.preventDefault();
        var id = $('#educationId').val();
        var formData = new FormData($('#editEducationForm')[0]);
        $('.text-danger').empty();
        $('.pre-loader').show();

        $.ajax({
            url: `/educations_update/${id}`,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
