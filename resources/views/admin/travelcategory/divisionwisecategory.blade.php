                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editSkillForm">
                            ...
                            <div class="mb-3">
                                <label for="editName" class="form-label">Amount</label>
                                <input type="text" class="form-control" id="editAmount" name="name">
                                <small class="text-danger name_error"></small>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    var table = $('.ProvinceList').DataTable({
        ...
        searching: true,
        ajax: {
            url: "{{ route('travel.category.data', ['id' => $id]) }}", // Pass the 'id' here
        },
        columns: [
            {
            data: null, 
