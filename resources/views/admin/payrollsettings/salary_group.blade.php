            ...
            <ul class="nav nav-tabs d-flex" id="myTab" role="tablist" style="justify-content:center;">
                <li class="nav-item" role="presentation">
                    <a href="{{ route('salary.component.list') }}">
                        <button class="nav-link {{ request()->routeIs('salary.component.list') ? 'active' : '' }} "
                            type="button">
                            Salary Component
                        </button>
                    </a>
                ...
                <li class="nav-item" role="presentation">
                    <a href="{{ route('salary.group.list') }}">
                        <button class="nav-link {{ request()->routeIs('salary.group.list') ? 'active' : '' }}  "
                            type="button">
                            Salary Group
                        </button>
                    </a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header ">
                            ...
                            <div class="card-title  button-container">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#appraisalModal">Add New Salary Group </button>
                            </div>
                        </div>
                                            ...
                                            <form id="createGroup">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12 ">
                                                        ...
                                                        <select name="salaryComponents[]" id="componentDropdown"
                                                            class="border rounded p-2 d-flex flex-wrap form-select align-items-center"
                                                            multiple required>
                                                ...
                                                <div clas="row">
                                                    <button id="submitComponentBtn" type="submit"
                        ...
                        <div>
                            <div class="modal fade groupDetailsModal" id="groupDetailsModal" tabindex="-1"
                        ...
                        if (response.status == true) {
                         ...
                         <div class="row mb-3 component-row" id="component-row-${response.salaryComponent.id}">
                          <div class="row mb-3">
                            ...
                            } else if (response.salaryComponent.component_value_type == 1 || response
