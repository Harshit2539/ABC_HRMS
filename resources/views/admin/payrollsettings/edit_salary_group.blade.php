        ...
        <div class="container-fluid mt-4">
            ...
            <div class="row justify-content-center">
                <div class="col-7 mt-5">
                    <div class="card p-3">
                        @php
                            $selectedComponents = $salaryGroupDetails->components
                        ...
                        <form id="editGroupForm">
                            <div class="form-row">
                                <div class="form-group col-md-12 ">
                                    ...
                                    <input type="hidden" class="form-control" name="group_id"
                                        value={{ $salaryGroupDetails->id }}>
                                    <input type="text" class="form-control" name="group_name"
                                        value={{ $salaryGroupDetails->salary_group_name }} required>
                                </div>

                                <div class="form-group col-md-12 ">
                                    <label class="form-label fw-semibold">Salary Component</label>
                                    <select name="salaryComponents[]" id="editComponentDropdown"
                                        class="border rounded p-2 d-flex flex-wrap form-select align-items-center" multiple
                                        required>

                                        @foreach ($salaryComponentList as $component)
                                            <option value={{ $component->id }}
                                                @if (in_array($component->id, $selectedComponents)) selected @endif>
                            ...
                            <div clas="row">
                                {{-- <a href="{{ route('salary.group.list') }}"> --}}
                                    <button id="updateGroupBtn" data-id=" {{ $salaryGroupDetails->id }}" type="submit"
                ...
                success: function(response) {
                    if (response.status === true) {
                        ...
                        <div class="row mb-3 component-row" id="component-row-${el.id}">
                            ...
                            } else if (el.component_value_type == 1 || el
                                .component_value_type == 2) {
                ...
                success: function(response) {
                    ...
                    if (response.status == true) {
                        ...
                        setTimeout(() => {
                            ...
                            window.location.href= `/salary_group`;
                            }, 1000)
                    };
                },
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == true) {
                        ...
                        if (response.salaryComponent.component_value_type == 3 || response
                            .salaryComponent.component_value_type == 4) {
                        ...
                        if (response.salaryComponent.component_value_type == 1 || response
                            .salaryComponent.component_value_type == 2) {
